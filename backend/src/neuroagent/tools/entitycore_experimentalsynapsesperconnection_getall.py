...
class ExperimentalSynapsesPerConnectionReadExtended(
    ExperimentalSynapsesPerConnectionRead
):
...
class ExperimentalSynapsesPerConnectionGetAllOutput(
    ListResponseExperimentalSynapsesPerConnectionRead
):
    """Entitycore class modification, with added links."""
...
class ExperimentalSynapsesPerConnectionGetAllTool(BaseTool):
    ...
    async def arun(self) -> ExperimentalSynapsesPerConnectionGetAllOutput:
        ...
        return ExperimentalSynapsesPerConnectionGetAllOutput(**response_data)
