...
class MorphologyGetAllInput(BaseModel):
    """Inputs for the morphology get all tool."""
...
class MorphologyGetAllTool(BaseTool):
    ...
    async def arun(self) -> ListResponseReconstructionMorphologyRead:
        ...
        """
        query_params = ReadManyReconstructionMorphologyGetParametersQuery(
            ...
            mtype__id=UUID(self.input_schema.mtype_id)
        ...
        response = await self.metadata.httpx_client.get(
            ...
            headers=headers,
            params=query_params.model_dump(exclude_defaults=True, mode="json"),
        )
