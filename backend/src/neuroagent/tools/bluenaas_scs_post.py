...
from neuroagent.tools.autogenerated_types.bluenaas import (
    ...
    RecordingLocation,
    RunSimulationApiBluenaasSimulationSingleNeuronVirtualLabIdProjectIdRunPostParametersQuery,
...
class SCSPostTool(BaseTool):
    ...
    async def arun(self) -> SCSPostToolOutput:
        ...
        params = RunSimulationApiBluenaasSimulationSingleNeuronVirtualLabIdProjectIdRunPostParametersQuery(
