...
#   timestamp: 2025-07-16T12:00:57+00:00
...
class ReadManyBrainAtlasGetParametersQuery(BaseModel):
    ...
    species__order_by: list[str] | None = Field(
        default=['name'], title='Species  Order By'
    )
    ...
    strain__order_by: list[str] | None = Field(
        default=['name'], title='Strain  Order By'
    )
...
class ReadManyCellCompositionGetParametersQuery(BaseModel):
    ...
    contribution__order_by: list[str] | None = Field(
    ...
    created_by__order_by: list[str] | None = Field(
    ...
    updated_by__order_by: list[str] | None = Field(
...
class ReadManyCircuitGetParametersQuery(BaseModel):
    ...
    brain_region__order_by: list[str] | None = Field(
    ...
    subject__species_id__in: list[UUID] | None = Field(
        default=None, title='Subject  Species Id  In'
    )
    subject__order_by: list[str] | None = Field(
    ...
    subject__species__order_by: list[str] | None = Field(
    ...
    subject__strain__order_by: list[str] | None = Field(
...
class ReadManyContributionGetParametersQuery(BaseModel):
    ...
    agent__order_by: list[str] | None = Field(
        default=['pref_label'], title='Agent  Order By'
    )
    ...
    entity__order_by: list[str] | None = Field(
...
class ReadManyElectricalCellRecordingGetParametersQuery(BaseModel):
    ...
    etype__order_by: list[str] | None = Field(
        default=['pref_label'], title='Etype  Order By'
    )
    contribution__id: UUID | None = Field(default=None, title='Contribution  Id')
    contribution__pref_label: str | None = Field(
        default=None, title='Contribution  Pref Label'
...
class ReadManyEmodelGetParametersQuery(BaseModel):
    ...
    mtype__order_by: list[str] | None = Field(
        default=['pref_label'], title='Mtype  Order By'
    )
    contribution__id: UUID | None = Field(default=None, title='Contribution  Id')
    contribution__pref_label: str | None = Field(
        default=None, title='Contribution  Pref Label'
    ...
    exemplar_morphology__order_by: list[str] | None = Field(
...
class ReadManyExperimentalSynapsesPerConnectionGetParametersQuery(BaseModel):
    ...
    pre_mtype__order_by: list[str] | None = Field(
    ...
    post_mtype__order_by: list[str] | None = Field(
    ...
    pre_region__order_by: list[str] | None = Field(
    ...
    post_region__order_by: list[str] | None = Field(
...
class ReadManyMemodelGetParametersQuery(BaseModel):
    ...
    morphology__order_by: list[str] | None = Field(
    ...
    emodel__species_id__in: list[UUID] | None = Field(
    ...
    emodel__order_by: list[str] | None = Field(
...
class ReadManySimulationCampaignGetParametersQuery(BaseModel):
    ...
    simulation__order_by: list[str] | None = Field(
...
class ReadManySimulationExecutionGetParametersQuery(BaseModel):
    ...
    used__order_by: list[str] | None = Field(
        default=['-creation_date'], title='Used  Order By'
    )
    ...
    generated__order_by: list[str] | None = Field(
...
class ReadManySingleNeuronSimulationGetParametersQuery(BaseModel):
    ...
    me_model__species_id__in: list[UUID] | None = Field(
    ...
    me_model__order_by: list[str] | None = Field(
...
class ReadManySingleNeuronSynaptomeSimulationGetParametersQuery(BaseModel):
    ...
    synaptome__order_by: list[str] | None = Field(
