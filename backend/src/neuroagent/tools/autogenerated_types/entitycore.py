...
#   timestamp: 2025-08-04T11:54:15+00:00
...
class ReadManyScientificArtifactPublicationLinkGetParametersQuery(BaseModel):
    ...
    publication__name: str | None = Field(default=None, title='Publication  Name')
    publication__name__in: list[str] | None = Field(
        default=None, title='Publication  Name  In'
    )
    publication__name__ilike: str | None = Field(
        default=None, title='Publication  Name  Ilike'
    )
