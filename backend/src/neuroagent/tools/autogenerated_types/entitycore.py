...
#   timestamp: 2025-05-30T14:20:36+00:00
...
class ValidationResultRead(BaseModel):
    created_by: PersonRead | None = None
    updated_by: PersonRead | None = None
    id: UUID = Field(..., title='Id')
    creation_date: datetime = Field(..., title='Creation Date')
    update_date: datetime = Field(..., title='Update Date')
    name: str = Field(..., title='Name')
...
ReadManyLicenseGetParametersQuery = ReadManyContributionGetParametersQuery
...
ReadManyOrganizationGetParametersQuery = ReadManyContributionGetParametersQuery


ReadManyPersonGetParametersQuery = ReadManyContributionGetParametersQuery


ReadManyRoleGetParametersQuery = ReadManyContributionGetParametersQuery
...
class AgentRead(RootModel[PersonRead | OrganizationRead]):
    root: PersonRead | OrganizationRead
...
class ReconstructionMorphologyRead(BaseModel):
    ...
    contributions: list[ContributionReadWithoutEntity] | None = Field(
        ..., title='Contributions'
    )
    mtypes: list[Annotation] | None = Field(..., title='Mtypes')
