...
class PredefinedNeuronSet(BaseModel):
    ...
    node_set: NodeSet | NodeSet1 = Field(
        ...,
        json_schema_extra={'circuit_property_type': 'CircuitNodeSet'},
        title='Node Set',
    )
...
class ConstantCurrentClampSomaticStimulus(BaseModel):
    ...
    neuron_set: NeuronSetReference = Field(
        ...
        json_schema_extra={'supports_virtual': False},
        title='Neuron Set',
    )
...
class FullySynchronousSpikeStimulus(BaseModel):
    ...
    source_neuron_set: NeuronSetReference = Field(
        ..., json_schema_extra={'supports_virtual': True}, title='Neuron Set (Source)'
    )
    targeted_neuron_set: NeuronSetReference = Field(
        ..., json_schema_extra={'supports_virtual': False}, title='Neuron Set (Target)'
    )
    timestamp_offset: float | list[float] | None = Field(
        default=0.0,
        description='The offset of the stimulus relative to each timestamp in milliseconds (ms).',
...
class SimulationsForm(BaseModel):
    ...
    timestamps: dict[str, SingleTimestamp | RegularTimestamps] | None = Field(
        ...
        json_schema_extra={
            'group': 'Setup',
            'group_order': 0,
            'reference_type': 'TimestampsReference',
    ...
    stimuli: (
        ...
        json_schema_extra={
            'group': 'Stimuli & Recordings',
            'group_order': 0,
            'reference_type': 'StimulusReference',
    ...
    recordings: (
        ...
        json_schema_extra={
            'group': 'Stimuli & Recordings',
            'group_order': 1,
            'reference_type': 'RecordingReference',
    ...
    synaptic_manipulations: (
        ...
        json_schema_extra={
            'group': 'Circuit Components',
            'group_order': 1,
            'reference_type': 'SynapticManipulationsReference',
    ...
    initialize: ObiOneScientificSimulationSimulationsSimulationsFormInitialize = Field(
        ...
        json_schema_extra={'group': 'Setup', 'group_order': 1},
        title='Initialization',
    )
    info: Info = Field(
        ...,
        description='Information about the simulation campaign.',
        json_schema_extra={'group': 'Setup', 'group_order': 0},
    )
