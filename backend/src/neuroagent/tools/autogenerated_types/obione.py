...
#   timestamp: 2025-05-30T14:19:40+00:00
...
class AfferentSynapsesBlock(BaseModel):
    type: Literal['AfferentSynapsesBlock'] = Field(..., title='Type')
    random_seed: int | list[int] | None = Field(
        default=0,
        description='Seed for the random selection of synapses',
        title='Random Seed',
    )
    ...
    pre_synapse_class: str | list[str] | None = Field(
        ...
        title='Pre Synapse Class',
    )
    consider_nan_pass: bool | list[bool] | None = Field(
        default=True,
        description="If False, synapses with no 'synapse_class' pass, else not.",
        title='Consider Nan Pass',
    )
    pre_node_populations: list[str] | list[list[str]] | None = Field(
        default=None,
        description='Names of presynaptic node populations to allow',
        title='Pre Node Populations',
    )
    merge_multiple_syns_con: bool | list[bool] | None = Field(
        default=False,
...
class ClusteredPDSynapsesByCount(BaseModel):
    type: Literal['ClusteredPDSynapsesByCount'] = Field(..., title='Type')
    random_seed: int | list[int] | None = Field(
        default=0,
        description='Seed for the random selection of synapses',
        title='Random Seed',
    ...
    n_clusters: int | list[int] | None = Field(
        default=1, description='Number of synapse clusters to find', title='N Clusters'
    )
...
class ClusteredPDSynapsesByMaxDistance(BaseModel):
    type: Literal['ClusteredPDSynapsesByMaxDistance'] = Field(..., title='Type')
    random_seed: int | list[int] | None = Field(
        default=0,
        description='Seed for the random selection of synapses',
        title='Random Seed',
...
class ClusteredSynapsesByCount(BaseModel):
    type: Literal['ClusteredSynapsesByCount'] = Field(..., title='Type')
    random_seed: int | list[int] | None = Field(
        default=0,
        description='Seed for the random selection of synapses',
        title='Random Seed',
...
class ClusteredSynapsesByMaxDistance(BaseModel):
    type: Literal['ClusteredSynapsesByMaxDistance'] = Field(..., title='Type')
    random_seed: int | list[int] | None = Field(
        default=0,
        description='Seed for the random selection of synapses',
        title='Random Seed',
...
class SimulationLevelName(RootModel[str]):
    root: str = Field(
        ...,
        description='Name within a simulation.',
        min_length=1,
        title='Simulation Level Name',
    )
...
class CombinedNeuronSet(BaseModel):
    ...
    simulation_level_name: SimulationLevelName | None = Field(
        default=None, title='Simulation Level Name'
    )
...
class PathDistanceConstrainedFractionOfSynapses(BaseModel):
    type: Literal['PathDistanceConstrainedFractionOfSynapses'] = Field(
        ..., title='Type'
    )
    random_seed: int | list[int] | None = Field(
        default=0,
    ...
    p: int | list[int] | None = Field(
        default=1.0, description='Fracton of synapses to pick', title='P'
    )
    soma_pd_min: float | list[float] | None = Field(
        default=0.0,
        description='Minimum path distance in um to the soma for synapses',
        title='Soma Pd Min',
    )
    soma_pd_max: float | list[float] | None = Field(
...
class PathDistanceConstrainedNumberOfSynapses(BaseModel):
    type: Literal['PathDistanceConstrainedNumberOfSynapses'] = Field(..., title='Type')
    random_seed: int | list[int] | None = Field(
        default=0,
        description='Seed for the random selection of synapses',
        title='Random Seed',
    ...
    n: int | list[int] | None = Field(
        default=1, description='Number of synapses to pick', title='N'
    )
    soma_pd_min: float | list[float] | None = Field(
        default=0.0,
        description='Minimum path distance in um to the soma for synapses',
...
class PathDistanceWeightedFractionOfSynapses(BaseModel):
    type: Literal['PathDistanceWeightedFractionOfSynapses'] = Field(..., title='Type')
    random_seed: int | list[int] | None = Field(
        default=0,
        description='Seed for the random selection of synapses',
        title='Random Seed',
...
class PathDistanceWeightedNumberOfSynapses(BaseModel):
    type: Literal['PathDistanceWeightedNumberOfSynapses'] = Field(..., title='Type')
    random_seed: int | list[int] | None = Field(
        default=0,
        description='Seed for the random selection of synapses',
        title='Random Seed',
...
class RandomlySelectedFractionOfSynapses(BaseModel):
    type: Literal['RandomlySelectedFractionOfSynapses'] = Field(..., title='Type')
    random_seed: int | list[int] | None = Field(
        default=0,
        description='Seed for the random selection of synapses',
        title='Random Seed',
...
class RandomlySelectedNumberOfSynapses(BaseModel):
    type: Literal['RandomlySelectedNumberOfSynapses'] = Field(..., title='Type')
    random_seed: int | list[int] | None = Field(
        default=0,
        description='Seed for the random selection of synapses',
        title='Random Seed',
...
class XyzLocation(ColumnsXyzItem):
    pass


class XYZExtracellularLocationSet(BaseModel):
    type: Literal['XYZExtracellularLocationSet'] = Field(..., title='Type')
    xyz_locations: list[XyzLocation] | list[list[XyzLocation]] | None = Field(
        default=[[0.0, 0.0, 0.0]], title='Xyz Locations'
    )
...
class ObiOneScientificBasicConnectivityPlotsBasicConnectivityPlotsBasicConnectivityPlotsInitialize(
    ...
    plot_types: list[str] | None = Field(
        default=['nodes', 'connectivity_global', 'connectivity_pathway'],
        title='Plot Types',
    )
...
class LinearCurrentClampSomaticStimulus(BaseModel):
    ...
    represents_physical_electrode: bool | None = Field(
        default=False,
...
class ObiOneScientificSimulationSimulationsSimulationsFormInitialize(BaseModel):
    ...
    circuit: list[Circuit] | Circuit = Field(..., title='Circuit')
    simulation_length: list[float] | float | None = Field(
        default=100.0, title='Simulation Length'
    )
    node_set: (
        PredefinedNeuronSet
        | CombinedNeuronSet
    ...
    random_seed: list[int] | int | None = Field(default=1, title='Random Seed')
    extracellular_calcium_concentration: list[float] | float | None = Field(
        default=1.1, title='Extracellular Calcium Concentration'
    )
    v_init: list[float] | float | None = Field(default=-80.0, title='V Init')
    spike_location: Literal['AIS', 'soma'] | list[Literal['AIS', 'soma']] | None = (
        Field(default='soma', title='Spike Location')
    )
    sonata_version: list[int] | int | None = Field(default=1, title='Sonata Version')
    target_simulator: list[str] | str | None = Field(
        default='CORENEURON', title='Target Simulator'
    )
    timestep: list[float] | float | None = Field(default=0.025, title='Timestep')
