...
#   filename:  https://staging.openbluebrain.com/api/obi-one/openapi.json
#   timestamp: 2025-07-02T13:15:31+00:00
...
class SimulationLengthItem(DurationItem):
    pass
...
class ObiOneScientificSimulationSimulationsSimulationsFormInitialize(BaseModel):
    ...
    simulation_length: list[SimulationLengthItem] | SimulationLength | None = Field(
        default=1000.0,
        description='Simulation length in milliseconds (ms).',
        title='Duration',
    )
...
class RCA1CA3Inputs(BaseModel):
    ...
    sample_percentage: SamplePercentage12 | SamplePercentage13 | None = Field(
        default=100.0,
        description='Percentage of neurons to sample between 0 and 100%',
        title='Sample (Percentage)',
    )
