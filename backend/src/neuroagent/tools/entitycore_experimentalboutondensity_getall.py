...
class ExperimentalBoutonDensityReadExtended(ExperimentalBoutonDensityRead):
...
class ExperimentalBoutonDensityGetAllTool(BaseTool):
    ...
    async def arun(self) -> ExperimentalBoutonDensityGetAllOutput:
        ...
        for density in response_data["data"]:
            ...
            density["url_link"] = (
                self.metadata.entitycore_links_url + "/bouton-density/" + density["id"]
            )

        return ExperimentalBoutonDensityGetAllOutput(**response_data)
