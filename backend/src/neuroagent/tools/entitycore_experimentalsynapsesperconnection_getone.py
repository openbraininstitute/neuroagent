...
class ExperimentalSynapsesPerConnectionGetOneMetadata(BaseMetadata):
    """Metadata class for ExperimentalSynapsesPerConnectionGetOneTool."""
...
class ExperimentalSynapsesPerConnectionGetOneTool(BaseTool):
    ...
    metadata: ExperimentalSynapsesPerConnectionGetOneMetadata
