...
class ExperimentalNeuronDensityReadExtended(ExperimentalNeuronDensityRead):
...
class ExperimentalNeuronDensityGetAllTool(BaseTool):
    ...
    async def arun(self) -> ExperimentalNeuronDensityGetAllOutput:
        ...
        for density in response_data["data"]:
            ...
            density["url_link"] = (
                self.metadata.entitycore_links_url + "/neuron-density/" + density["id"]
            )

        return ExperimentalNeuronDensityGetAllOutput(**response_data)
