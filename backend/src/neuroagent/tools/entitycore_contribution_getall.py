...
class ContributionGetAllMetadata(BaseMetadata):
    """Metadata class for ContributionGetAllTool."""
...
class ContributionGetAllTool(BaseTool):
    ...
    metadata: ContributionGetAllMetadata
    input_schema: ReadManyContributionGetParametersQuery
