...
from neuroagent.tools.autogenerated_types.literature import (
    DateFrom,
    DateTo,
    Journal,
    ParagraphMetadata,
    RetrievalRetrievalGetParametersQuery,
)
...
class LiteratureSearchTool(BaseTool):
    ...
    async def arun(self) -> LiteratureSearchToolOutput:
        ...
        params = RetrievalRetrievalGetParametersQuery(
            query=self.input_schema.user_message,
            article_types=self.input_schema.article_types,
            authors=self.input_schema.authors,
            journals=[Journal(root=journal) for journal in self.input_schema.journals]
