...
class ExperimentalBoutonDensityGetOneMetadata(BaseMetadata):
    """Metadata class for ExperimentalBoutonDensityGetOneTool."""
...
class ExperimentalBoutonDensityGetOneTool(BaseTool):
    ...
    metadata: ExperimentalBoutonDensityGetOneMetadata
