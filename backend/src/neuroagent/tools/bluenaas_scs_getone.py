...
from neuroagent.tools.autogenerated_types.bluenaas.schemas import (
    GetSimulationApiBluenaasSimulationSingleNeuronVirtualLabIdProjectIdSimulationIdGetParams,
)
...
class SCSGetOneTool(BaseTool):
    ...
    async def arun(self) -> SimulationDetailsResponse:
        ...
        params = GetSimulationApiBluenaasSimulationSingleNeuronVirtualLabIdProjectIdSimulationIdGetParams(
            virtual_lab_id=self.metadata.vlab_id,
            project_id=self.metadata.project_id,
            simulation_id=self.input_schema.simulation_id,
        )
        ...
        return SimulationDetailsResponse(**result)
