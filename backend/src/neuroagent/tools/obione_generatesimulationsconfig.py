...
The tool handles two primary use cases:
1. **New configurations**: Complete descriptions for building configurations from scratch
2. **Configuration modifications**: Changes to existing configurations
...
"""
        ...
        if response.choices[0].message.parsed:
            ...
            patches = make_patch(base_simulation_form.model_dump(), output_config.model_dump()).patch
