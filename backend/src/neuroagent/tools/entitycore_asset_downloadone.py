...
from neuroagent.autogenerated_types.entitycore import EntityRoute
...
class AssetDownloadOneTool(BaseTool):
    ...
    async def arun(self) -> AssetDownloadOneOutput:
        ...
        response = await self.metadata.httpx_client.get(
            url=f"{self.metadata.entitycore_url.rstrip('/')}/{self.input_schema.entity_route.root}/{self.input_schema.entity_id}/assets/{self.input_schema.asset_id}/download",
            headers=headers,
