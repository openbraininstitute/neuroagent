...
class ElectricalCellRecordingOutput(ElectricalCellRecordingRead):
...
class ElectricalCellRecordingGetAllTool(BaseTool):
    ...
    async def arun(self) -> ElectricalCellRecordingGetAllOutput:
        ...
        return ElectricalCellRecordingGetAllOutput(**response_data)
