...
class EditStateOutput(BaseModel):
    ...
    state: SharedState = Field(description="The updated state after applying patches")
    url_links: dict[str, str] | None = None


_SHARED_STATE_SCHEMA = CircuitSimulationScanConfig.model_json_schema()
...
"""
    ...
    async def arun(self) -> EditStateOutput:
        ...
        updated_state = SharedState(**jsonpatch.apply_patch(current_state, patch_dicts))
    ...
    def get_return_url(self, state: SharedState) -> dict[str, str] | None:
