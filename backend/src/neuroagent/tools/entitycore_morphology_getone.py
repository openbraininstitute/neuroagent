...
from neuroagent.tools.autogenerated_types.entitycore.schemas import (
    ReadOneReconstructionMorphologyIdGetParams,
)
...
class MorphologyGetOneQueryParams(ReadOneReconstructionMorphologyIdGetParams):
    """Query parameters for MorphologyGetOneTool with skipped JSON schema for certain fields."""

    id_: SkipJsonSchema[UUID] = None
...
class MorphologyGetOneTool(BaseTool):
    ...
    async def arun(self) -> ReconstructionMorphologyIdGetResponse:
        ...
        # Create query parameters (excluding the ID which goes in the path)
        query_params = MorphologyGetOneQueryParams()
        ...
        return ReconstructionMorphologyIdGetResponse(**response.json())
