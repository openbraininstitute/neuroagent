...
class ElectricalCellRecordingGetOneMetadata(BaseMetadata):
    """Metadata class for ElectricalCellRecordingGetOneTool."""
...
class ElectricalCellRecordingGetOneTool(BaseTool):
    ...
    metadata: ElectricalCellRecordingGetOneMetadata
