...
class ReconstructionMorphologyGetOneMetadata(BaseMetadata):
    """Metadata class for ReconstructionMorphologyGetOneTool."""
...
class ReconstructionMorphologyGetOneTool(BaseTool):
    ...
    metadata: ReconstructionMorphologyGetOneMetadata
