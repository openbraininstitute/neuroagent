...
class ReconstructionMorphologyReadExtended(ReconstructionMorphologyRead):
    """Extended pydantic class."""

    url_link: str


class ReconstructionMorphologyAnnotationExpandedReadExtended(
    ReconstructionMorphologyAnnotationExpandedRead
):
    """Extended pydantic class."""
...
class ReconstructionMorphologyGetOneOutput(
    RootModel[
        ReconstructionMorphologyReadExtended
        | ReconstructionMorphologyAnnotationExpandedReadExtended
    ]
):
...
class ReconstructionMorphologyGetOneTool(BaseTool):
    ...
    async def arun(self) -> ReconstructionMorphologyGetOneOutput:
