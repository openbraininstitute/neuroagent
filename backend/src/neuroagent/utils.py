...
async def get_frontend_description(
    url: str,
    entitycore_url: str,
    vlab_id: uuid.UUID | None,
    ...
    if page_type == "home":
        ...
        if "br_id" in query_params:
            ...
            current_brain_region = (
                BrainRegionRead(**response.json()).name,
                query_params["br_id"][0],
            )
        else:
            current_brain_region = ("Unknown", "Unknown")
        ...
        if (
            ...
            if len(page_path) > 3:
                ...
                match page_path[3]:
                    ...
                    case "electrophysiology":
                        page_description += descriptions["explore-electrophysiology"]
                    case "neuron-density":
                ...
                page_description += f"## Current user view \n\n The user is currenly viewing information about brain region : {current_brain_region[0]}, with ID : {current_brain_region[1]}.\n"
            ...
            entity_mapping = {
                ...
                "electrophysiology": "electric-cell-recording",
            ...
            if entity_id:
                ...
                page_description += f"## Current user view \n\n The user is currenly viewing information about {entity_type}, with name : {response.json()['name']}, with ID : {entity_id}.\n"
