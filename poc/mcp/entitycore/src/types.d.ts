...
export interface components {
    schemas: {
        ...
        AgentRead: components["schemas"]["PersonRead"] | components["schemas"]["OrganizationRead"];
        /** Annotation */
        Annotation: {
            /**
             * Creation Date
         ...
         * @enum {string}
         */
        ApiErrorCode: "GENERIC_ERROR" | "NOT_AUTHENTICATED" | "NOT_AUTHORIZED" | "INVALID_REQUEST" | "ENTITY_NOT_FOUND" | "ENTITY_FORBIDDEN" | "ENTITY_DUPLICATED" | "ASSET_NOT_FOUND" | "ASSET_DUPLICATED" | "ASSET_INVALID_FILE" | "ASSET_MISSING_PATH" | "ASSET_INVALID_PATH" | "ASSET_NOT_A_DIRECTORY" | "ASSET_INVALID_SCHEMA" | "ION_NAME_NOT_FOUND";
        /**
         * AssetLabel
         * @enum {string}
         */
        ...
        EModelRead: {
            ...
            /** Contributions */
            contributions: components["schemas"]["ContributionReadWithoutEntity"][] | null;
            /** Mtypes */
        ...
        ElectricalCellRecordingRead: {
             ...
             */
            stimuli?: components["schemas"]["ElectricalRecordingStimulusRead"][] | null;
        };
        /**
         ...
         * @enum {string}
         */
        ElectricalRecordingStimulusShape: "cheops" | "constant" | "pulse" | "step" | "ramp" | "noise" | "sinusoidal" | "other" | "two_steps" | "unknown";
        /**
         * ElectricalRecordingStimulusType
         * @enum {string}
         */
        ElectricalRecordingStimulusType: "voltage_clamp" | "current_clamp" | "conductance_clamp" | "extracellular" | "other" | "unknown";
        /**
         * ElectricalRecordingType
         * @enum {string}
         */
        ElectricalRecordingType: "intracellular" | "extracellular" | "both" | "unknown";
        /** EntityRead */
        EntityRead: {
            /**
             * Id
         ...
         * @enum {string}
         */
        EntityRoute: "age" | "analysis-software-source-code" | "emodel" | "experimental-bouton-density" | "experimental-neuron-density" | "experimental-synapses-per-connection" | "memodel" | "mesh" | "reconstruction-morphology" | "electrical-cell-recording" | "electrical-recording-stimulus" | "single-neuron-simulation" | "single-neuron-synaptome" | "single-neuron-synaptome-simulation" | "ion-channel-model" | "subject" | "synaptic-pathway";
        /**
         * EntityType
         * @description Entity types.
         * @enum {string}
         */
        EntityType: "age" | "analysis_software_source_code" | "emodel" | "experimental_bouton_density" | "experimental_neuron_density" | "experimental_synapses_per_connection" | "memodel" | "mesh" | "reconstruction_morphology" | "electrical_cell_recording" | "electrical_recording_stimulus" | "single_neuron_simulation" | "single_neuron_synaptome" | "single_neuron_synaptome_simulation" | "ion_channel_model" | "subject" | "synaptic_pathway";
        /**
         * ErrorResponse
         ...
         * @enum {string}
         */
        MeasurementStatistic: "mean" | "median" | "mode" | "variance" | "data_point" | "sample_size" | "standard_error" | "standard_deviation" | "raw" | "minimum" | "maximum" | "sum";
        /**
         * MeasurementUnit
         * @enum {string}
         */
        MeasurementUnit: "dimensionless" | "1/μm" | "1/mm³" | "μm" | "μm²" | "μm³" | "radian";
        /** NestedMEModel */
        NestedMEModel: {
            /**
             * Id
        ...
        ReconstructionMorphologyAnnotationExpandedRead: {
            ...
            /** Mtypes */
            mtypes: components["schemas"]["Annotation"][] | null;
            measurement_annotation: components["schemas"]["MeasurementAnnotationRead"] | null;
        };
    ...
    read_many_emodel_get: {
        parameters: {
            query?: {
                ...
                measurement_kind__structural_domain?: components["schemas"]["StructuralDomain"] | null;
                measurement_item__name?: components["schemas"]["MeasurementStatistic"] | null;
                measurement_item__unit?: components["schemas"]["MeasurementUnit"] | null;
    ...
    read_one_reconstruction_morphology__id___get: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ReconstructionMorphologyRead"] | components["schemas"]["ReconstructionMorphologyAnnotationExpandedRead"];
                };
            };
            /** @description Not found */
            404: {
    ...
    read_many_single_neuron_simulation_get: {
        parameters: {
            query?: {
                ...
                me_type__validation_status?: components["schemas"]["ValidationStatus"] | null;
